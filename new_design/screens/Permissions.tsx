...
const Permissions: React.FC<PermissionsProps> = ({ onNavigate }) => {
  return (
    <div className="flex flex-col h-full bg-background-dark animate-fade-in-up">
      <div className="p-4 flex items-center justify-center relative">
        <button onClick={() => onNavigate(ScreenType.LOGIN)} className="absolute left-4 p-2">
      ...
      <div className="flex-1 flex flex-col items-center px-6 pt-10">
        <div className="w-full h-56 rounded-3xl overflow-hidden mb-10 relative">
          <div 
          ...
          <div className="p-5 bg-card-dark rounded-3xl flex gap-4 border border-white/5">
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center justify-between">
                ...
                <button className="px-5 py-1.5 bg-primary rounded-full text-white text-xs font-bold shadow-lg shadow-primary/20">Enable</button>
              </div>
            </div>
          </div>
          ...
          <div className="p-5 bg-card-dark rounded-3xl flex gap-4 border border-white/5">
            ...
            <div className="flex-1">
              ...
              <div className="flex justify-end mt-2">
                <button className="px-5 py-1.5 bg-gray-800 rounded-full text-white text-xs font-bold">Allow</button>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="p-6 pb-12 pt-4 bg-background-dark border-t border-white/5">
        <button 
          ...
          className="w-full h-16 bg-primary rounded-2xl text-white font-bold text-lg shadow-xl shadow-primary/20"
        >
          Continue
        </button>

          ...
          {isHost && (
            <div className="flex gap-2">
              <button
                ...
                className="px-4 h-12 bg-primary rounded-2xl flex items-center gap-2 justify-center text-white shadow-lg shadow-primary/30 active:scale-95 transition-all"
              >
                <span className="material-symbols-outlined">person_add</span>
                <span className="font-bold text-sm">{t('meeting_invite')}</span>
              </button>
            </div>
          )}
        </div>

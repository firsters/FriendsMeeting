...
const FriendsList = () => {
  ...
  const requests = [
    { id: '1', name: 'Sarah Jenkins', status: t('friends_share_req'), avatar: 'S' },
    { id: '2', name: 'Mike Ross', status: `${t('friends_mutual')}: Harvey S.`, avatar: 'M' },
  ];

  const friends = [
    { id: '1', name: 'Jessica Pearson', status: `Downtown • 2km`, avatar: 'J', online: true },
    { id: '2', name: 'Louis Litt', status: `2h ${t('friends_last_seen')}`, avatar: 'L', online: false },
    { id: '3', name: 'Donna Paulsen', status: `Central Park • 500m`, avatar: 'D', online: true },
    { id: '4', name: 'Rachel Zane', status: `10m ${t('friends_idle')}`, avatar: 'R', online: true, idle: true },
  ];
    ...
    <div className="flex flex-col h-full bg-slate-900 text-white overflow-hidden">
      ...
      <div className="sticky top-0 z-50 bg-slate-900/95 backdrop-blur-md p-4 pb-2 border-b border-white/5">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-2xl font-bold leading-tight tracking-tight">{t('friends_list')}</h2>
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-6 pb-24">
        {/* Pending Requests */}
        <section>
          <h3 className="text-[10px] font-bold uppercase tracking-widest text-slate-500 mb-3 px-1">{t('friends_requests')} ({requests.length})</h3>
        ...
        {/* All Friends */}
        <section>
          <h3 className="text-[10px] font-bold uppercase tracking-widest text-slate-500 mb-3 px-1">{t('friends_all')} (42)</h3>

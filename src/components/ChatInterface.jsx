...
const ChatInterface = ({ height, onImageClick }) => {
  const [messages, setMessages] = useState([
    { id: '1', sender: 'Alex', text: 'Hey, are we still meeting at 5?', type: 'text', time: '14:20' },
    { id: '2', sender: 'Me', text: "Yeah, I'm on my way!", type: 'text', time: '14:21' },
    { id: '3', sender: 'Sam', type: 'image', imageUrl: 'https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=400&q=80', time: '14:22' },
    { id: '4', sender: 'Sam', text: "Just arrived at the cafe ☕️", type: 'text', time: '14:22' },
  ]);
